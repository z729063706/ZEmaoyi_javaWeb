       ...
       <div class="container">
        <div class="row">
            <div class="col-lg-5 col-md-12 col-xs-12 title">
                <img src="./中俄贸易供需服务平台-首页_files/title.png" class="img-responsive">
            </div>
            <div class="col-lg-7 col-md-12 col-xs-12 ">
                <div class="divm">
                    <div> <object data="./中俄贸易供需服务平台-首页_files/u4.svg" width="21" height="21" class="tel"></object>
                    <div class="ph">
                ...
                <div class="signedin">
                	<p><img src="./中俄贸易供需服务平台-首页_files/notice.jpg" class="hidden-xs">
                	欢迎<img src="./中俄贸易供需服务平台-首页_files/vip.jpg" width="27px" height="15px" id="vip"><a href="javascript:void(0);" id="cName">北京市京海换热设备制造有限责任公司</a></p>
                	<div class="btns"> 
    ...
    <nav class="navbar navbar-default " role="navigation">
        ...
        <div class="navbar-header">
            ...
            <div class="clearfix pull-left">                        
                <a href="http://114.55.145.59/rctms/home_detail/adminlogin.jsp" target="_blank" class="pull-right">
                    <img src="./中俄贸易供需服务平台-首页_files/logo.png" width="166px" height="59px">
                </a>
            </div>
        </div>
        <div class="collapse navbar-collapse" id="example-navbar-collapse">
            <ul class="nav navbar-nav">
                <li><a href="http://114.55.145.59/rctms/index.jsp" target="_blank">新闻与资讯>首  页</a></li>
                <li><a href="http://114.55.145.59/rctms/home_detail/purchase.jsp" target="_blank">国际采购</a></li>
                <li><a href="http://114.55.145.59/rctms/home_detail/supply.jsp" target="_blank">国际供应</a></li>
                <li><a href="http://114.55.145.59/rctms/home_detail/logistics.jsp" target="_blank">国际物流</a></li>
                <li><a href="http://114.55.145.59/rctms/home_detail/news.jsp" target="_blank">新闻与资讯</a></li>
                <li><a href="http://114.55.145.59/rctms/home_detail/about.jsp" target="_blank">关于我们</a></li>
            </ul>
        </div>
        </div>
    </nav>
